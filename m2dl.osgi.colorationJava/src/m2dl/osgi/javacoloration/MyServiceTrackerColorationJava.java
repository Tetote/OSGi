...
public class MyServiceTrackerColorationJava implements ServiceTrackerCustomizer<ParserService, ParserService>{

	
	private final BundleContext context;

	public MyServiceTrackerColorationJava(BundleContext _context) {
		context = _context;
	}
